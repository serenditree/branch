...
import io.serenditree.branch.user.model.serde.RoleSetDeserializer;
import io.serenditree.branch.user.model.serde.RoleSetSerializer;
import io.serenditree.fence.model.AbstractTimestampedFenceEntity;
import io.serenditree.fence.model.api.FenceEntity;
import io.serenditree.fence.model.api.FenceUser;
import io.serenditree.fence.model.enums.RoleType;
import io.serenditree.root.data.generic.model.validation.ValidationGroups;
import io.serenditree.root.util.oak.OakEmail;
...
public class User extends AbstractTimestampedFenceEntity<Long> implements FenceUser<Role>, FenceEntity<Long> {
    ...
    @Size(min = 10)
    @Pattern(regexp = OakPassword.PASSWORD_REGEX)
    private String password;

    @Pattern(regexp = OakEmail.EMAIL_REGEX, flags = Pattern.Flag.CASE_INSENSITIVE)

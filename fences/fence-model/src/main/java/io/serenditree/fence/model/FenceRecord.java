...
@NamedQuery(
    name = FenceRecord.DELETE_BY_USER,
    query = "DELETE FROM FenceRecord " +
            "WHERE " + FenceRecord.USER_REFERENCE + " = :" + FenceRecord.USER_REFERENCE
)
@NamedQuery(
...
public class FenceRecord extends AbstractEntity {
    ...
    public static final String DELETE_BY_USER = "FenceRecord.deleteByUser";

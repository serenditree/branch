...
import io.serenditree.root.rest.cache.annotation.CustomCacheControl;
import io.serenditree.root.rest.transfer.ApiDescription;
...
public abstract class AbstractFenceEndpoint {
    ...
    @Inject
    @FenceContext
    io.serenditree.fence.model.FenceContext fenceContext;
    ...
    public Response retrieveAuthInformation(
     ...
     */
    protected <E> Response buildCacheResponse(
        E result,
     ...
     */
    protected <E> Response.ResponseBuilder buildResponseBuilder(
        E result,
        Predicate<E> predicate,
        Response.Status success,
        Response.Status error
     ...
     */
    protected <E> Response buildResponse(
        E result,
        Predicate<E> predicate,
        Response.Status success,
        Response.Status error
    ...
    /**
     * Returns the {@link FencePrincipal} from the {@link io.serenditree.fence.model.FenceContext}.
     *
    ...
    /**
     * Builds a {@link Response} with security headers from the {@link io.serenditree.fence.model.FenceContext}.
     *
    ...
    /**
     * Builds a response that can be processed by the {@link io.serenditree.fence.interceptor.FenceRecordInterceptor}.
     *
     * @param result    Result from service.
     * @param predicate Predicate for testing the result.
     * @param entityId  ID for the {@link io.serenditree.fence.model.FenceRecord} to create.
     * @param success   {@link Response.Status} after successful test.
     * @param error     {@link Response.Status} after failed test.
     * @param <E>       Type of the results from services.
     * @return {@link Response} with response entity.
     */
    protected <E> Response buildFenceResponse(
        E result,
        Predicate<E> predicate,
        String entityId,
        Response.Status success,

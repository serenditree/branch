...
public class SeedLeaf extends AbstractFenceEndpoint {
    ...
    @Operation(
        extensions = {
            ...
            @Extension(name = FenceOASFilter.SORTED, value = "100")
        }
    )
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Open
    @Operation(extensions = @Extension(name = FenceOASFilter.SORTED, value = "102"))
    ...
    @Operation(
        extensions = {
            @Extension(name = FenceOASFilter.FENCED, value = "true"),
            @Extension(name = FenceOASFilter.SORTED, value = "104")
        }
    )
    ...
    @Operation(
        extensions = {
            @Extension(name = FenceOASFilter.FENCED, value = "true"),
            @Extension(name = FenceOASFilter.SORTED, value = "105")
        }
    )
